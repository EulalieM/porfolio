...
<head>
    ...
    <meta property="og:url" content="https://eulalie.sitesweb-angouleme.fr/realisations.php">
    ...
    <meta property="og:image" content="https://eulalie.sitesweb-angouleme.fr/realisations.php/img/eulalie_photo_meta.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://eulalie.sitesweb-angouleme.fr/realisations.php">
    ...
    <meta property="twitter:image" content="https://eulalie.sitesweb-angouleme.fr/realisations.php/img/eulalie_photo_meta.png">
        ...
        <div>
            ...
            <div class="rea-project rea-project-left">
                ...
                <div class="rea-description">
                    ...
                    <a href="macagettecharentaise" class="rea-cta cta">Voir le projet</a>
                </div>
            </div>
            <div class="rea-project rea-project-right">
                <div class="rea-description">
                    ...
                    <a href="kentuckyburger" class="rea-cta cta">Voir le projet</a>
                </div>
                <div class="rea-picture">
