...
<head>
    ...
    <meta property="og:url" content="https://eulalie-moreau.fr/macagettecharentaise.php">
    ...
    <meta property="og:image" content="https://eulalie-moreau.fr/ces.php/img/mockup_macagette.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://eulalie-moreau.fr/macagettecharentaise.php">
    ...
    <meta property="twitter:image" content="https://eulalie-moreau.fr/ces.php/img/mockup_macagette.png">
...
<body>
    ...
    <main>
        <div>
            ...
            <div class="pro-nav">
                <span><a href="ces">Projet précédent </a>|<a href="kentucky-burger"> Projet suivant</a></span>
            </div>
